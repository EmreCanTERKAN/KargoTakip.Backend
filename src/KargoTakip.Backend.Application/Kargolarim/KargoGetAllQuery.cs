...
internal sealed class KargoGetAllQueryHandler(IKargoRepository kargoRepository, UserManager<AppUser> userManager) : IRequestHandler<KargoGetAllQuery, IQueryable<KargoGetAllQueryResponse>>
{
